...
import Foundation
import UIKit
class YoPageMainViewCtl: YoBaseUIViewController {
    //    //UI 背景层
    private lazy var topBackgroundView: UIView = {
        let topBg = UIView.init(frame: CGRect(x: 0, y: 0,
                                              width: view.frame.size.width,
                                              height: CGFloat.safeAreaNavBarHeight))
