...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/LJTagsView/LJTagsView.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Storable/Storable.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/WeakMapTable/WeakMapTable.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/YoCommon/YoCommon.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/YoNavBarView/YoNavBarView.framework"
fi
